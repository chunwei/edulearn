          ...
          <Card>
            ...
            <CardContent>
              <div className="bg-gray-50 rounded-lg p-4 text-center mb-4">
                <p className="text-gray-500 text-sm">Analytics chart will be displayed here</p>
                <div className="h-64 mt-2 rounded-lg border border-dashed border-gray-300 flex items-center justify-center">
                  <div className="text-gray-400">
                    ...
                    <p className="text-xs mt-1">Monthly active users over time</p>
                  </div>
                </div>
              </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {[1, 2, 3, 4, 5].map((item) => (
                      <tr key={item} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                          {item % 3 === 0 ? 'Course #12' : item % 3 === 1 ? 'Course #45' : 'User settings'}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          ...
                          >
                            {item % 3 === 0 ? 'Completed' : item % 3 === 1 ? 'In Progress' : 'Pending'}
                          </span>
                        </td>
                      </tr>
                    ))}
            ...
            <CardContent className="p-0">
              <ul className="divide-y divide-gray-200">
                {[
                  ...
                  <li key={index} className="px-4 py-3 hover:bg-gray-50 flex items-center">
                    <input
                      type="checkbox"
