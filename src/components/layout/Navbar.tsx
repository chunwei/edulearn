        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/dashboard" className="text-xl font-bold text-blue-600">EduLearn</Link>
            </div>
              ...
              <div className="ml-3 relative group">
                <button className="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 items-center">
                  ...
                  <img
                    ...
                    src={user.avatar || 'https://images.pexels.com/photos/1438072/pexels-photo-1438072.jpeg?auto=compress&cs=tinysrgb&w=100'}
                    alt={user.name}
                  />
                ...
                <div 
                  className="origin-top-right absolute right-0 top-full -mt-px w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible focus:outline-none transition ease-in-out duration-100 z-50"
                >
              ...
              <div className="flex items-center px-4">
                <div className="flex-shrink-0">
                  <Avatar className="h-10 w-10 rounded-full">
                    <AvatarImage src={user.avatar || 'https://images.pexels.com/photos/1438072/pexels-photo-1438072.jpeg?auto=compress&cs=tinysrgb&w=100'} alt={user.name} />
                    <AvatarFallback>
                      {user.name ? user.name.substring(0,1).toUpperCase() : <UserCircle2 className="h-10 w-10 text-gray-400" />}
                    </AvatarFallback>
                  </Avatar>
                </div>
                <div className="ml-3">
